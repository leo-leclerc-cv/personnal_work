...
function gameOver () {
	...
	document.getElementById("newsRudolf").insertAdjacentHTML("beforeEnd", '<audio autoplay ><source src="public/audio/GameOver.ogg" type="audio/ogg">Your browser does not support the audio tag.</audio>');
	clearInterval(intervalInconnu);
	clearInterval(intervalDescente0);
	clearInterval(intervalDescente1);
	clearInterval(intervalDescente2);
...
function pointSonResultat (pts) {
	...
	if (sound!==2) {
		document.getElementById("newsRudolf").insertAdjacentHTML("beforeEnd", '<audio id="collect_audio" autoplay ><source src="public/audio/Collect.ogg" type="audio/ogg">Your browser does not support the audio tag.</audio>');
...
document.getElementById("sound").addEventListener("click", function (e) {
	if (sound===66) {
		...
		document.getElementById("aside_droite").insertAdjacentHTML("beforeEnd", '<audio id="sound_audio" autoplay loop ><source src="public/audio/Free_Christmas_Music_8-Bit_Jingle_Bells.ogg" type="audio/ogg">Your browser does not support the audio tag.</audio>');
