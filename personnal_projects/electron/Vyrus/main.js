...
if (debug) {
  ...
  fs.writeFileSync(__dirname+"/public/json/Vyrus.json", JSON.stringify(packageToLocalVersion) );
  debugLog("Vyrus.json updated");
}
...
function errorLog(log) {
  ...
  dialog.showErrorBox("Vyrus, Une importante erreur a été rencontrée : ", log);
}
